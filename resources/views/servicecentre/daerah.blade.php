      ...
      <div class="container-fluid">
        ...
        <?php
            foreach ($kabupaten as $item){
                ...
                $query = $sparql->query('SELECT * WHERE {?s motor:MemilikiLokasi motor:'.$namakabupaten.'. ?s rdf:type motor:NamaServiceCentre}');
                $jumlah = 0;
                foreach ($query as $it){
                    $jumlah = $jumlah + 1;
                }
        ?>
          <div class="col-lg-3 col-6  mt-4 ml-2">
            ...
            <div class="small-box bg-ligth">
              ...
              <a href="{{ url('/servicecentre/'.$daerah.'/'.$namakabupaten.'/') }}" class="small-box-footer" style="color: black;">Lihat <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
        <?php
            }
