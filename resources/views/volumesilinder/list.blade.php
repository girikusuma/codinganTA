...
$qr = "SELECT * WHERE {?s motor:MemilikiVolumeSilinder motor:".$volume.". ?s motor:MemilikiNama ?n}";
  ...
  <div class="row">
    <div class="col">
      <div class="content-header">
        <h1 class="m-0 text-dark">Sepeda Motor dengan Volume Silinder {{ $volume }}</h1>
        <hr>
      </div>
      <section class="content">
        ...
        if ($i == "0") {
            echo "Tidak ada data Sepeda Motor dengan Volume Silinder ".$volume;
          }
        ?>
      </section>
    </div>
